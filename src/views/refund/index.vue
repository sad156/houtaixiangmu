<template>
  <div class="app-container">
    ...
    >
      ...
      <!-- 用户名 -->
      <el-table-column :label="$t('table.refund.userName')" align="center" width="120">
        <template slot-scope="scope">
      ...
      <!-- 用户联系方式 -->
      <el-table-column :label="$t('table.refund.userPhone')" align="center" width="120">
        <template slot-scope="scope">
      ...
      <!-- 详细地址 -->
      <el-table-column :label="$t('table.refund.address')" align="center" width="300">
        <template slot-scope="scope">
      ...
      <!-- 退机原因 -->
      <el-table-column :label="$t('table.refund.refundCause')" align="center" width="100">
        <template slot-scope="scope">
      ...
      <!-- 退机状态 -->
      <el-table-column :label="$t('table.refund.refundType')" align="center" width="80">
        <template slot-scope="scope">
          <span>{{ scope.row.refundType }}</span>
        </template>
      </el-table-column>

      <!-- 服务站名称 -->
      <el-table-column :label="$t('table.refund.stationName')" align="center" width="200">
        <template slot-scope="scope">
      ...
      <!-- 服务站审批时间 -->
      <!-- <el-table-column :label="$t('table.refund.stationTime')" align="center" width="150">
          <template slot-scope="scope">
            <span>{{ scope.row.stationTime | parseTime('{y}-{m}-{d} {h}:{i}') }}</span>
          </template>
        </el-table-column> -->

      <!-- 经销商名称 -->
      <el-table-column :label="$t('table.refund.dealerName')" align="center" width="200">
        <template slot-scope="scope">
      ...
      <!-- 经销商审批时间 -->
      <!-- <el-table-column :label="$t('table.refund.dealerTime')" align="center" width="150">
          <template slot-scope="scope">
            <span>{{ scope.row.dealerTime | parseTime('{y}-{m}-{d} {h}:{i}') }}</span>
          </template>
        </el-table-column> -->

      <!-- 经销商电话 -->
      <el-table-column :label="$t('table.refund.dealerPhone')" align="center" width="200">
        <template slot-scope="scope">
      ...
      <!-- 管理员名称 -->
      <el-table-column :label="$t('table.refund.adminName')" align="center" width="200">
        <template slot-scope="scope">
      ...
      <!-- 管理员审批时间 -->
      <!-- <el-table-column :label="$t('table.refund.adminTime')" align="center" width="150">
          <template slot-scope="scope">
            <span>{{ scope.row.adminTime | parseTime('{y}-{m}-{d} {h}:{i}') }}</span>
          </template>
        </el-table-column> -->
