<template>
  <div class="app-container">
    ...
    >
      ...
      <!-- 业务类型 -->
      <el-table-column :label="$t('table.operlog.businessType')" align="center" width="120">
        <template slot-scope="scope">
      ...
      <!-- 模块标题 -->
      <el-table-column :label="$t('table.operlog.title')" align="center" width="120">
        <template slot-scope="scope">
      ...
      <!-- 主机地址 -->
      <el-table-column :label="$t('table.operlog.operIp')" align="center" width="150">
        <template slot-scope="scope">
      ...
      <!-- 操作人员 -->
      <el-table-column :label="$t('table.operlog.operName')" align="center" width="100">
        <template slot-scope="scope">
      ...
      <!-- 错误信息 -->
      <el-table-column :label="$t('table.operlog.errorMsg')" align="center" width="200">
        <template slot-scope="scope">
      ...
      <!-- 操作地点 -->
      <el-table-column :label="$t('table.operlog.operLocation')" align="center" width="200">
        <template slot-scope="scope">
      ...
      <!-- 操作状态 -->
      <el-table-column :label="$t('table.operlog.status')" align="center" width="200">
        <template slot-scope="scope">
      ...
      <!-- 操作时间 -->
      <!-- <el-table-column :label="$t('table.operlog.operTime')" align="center" width="150">
          <template slot-scope="scope">
        ...
        <div style="display:flex;width:100%">
          ...
          <div style="width:50%;margin-left:10px">
            ...
            <el-form-item :label="$t('table.people.stname')">
              <wlTreeSelect v-model="temp.id" :data="treeData" style="width:177.75px;" @change="hindleChanged" />
            </el-form-item>
