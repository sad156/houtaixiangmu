<template>
  <div class="app-container">
    ...
    >
      ...
      <!-- 用户名 -->
      <el-table-column :label="$t('table.subscribe.uname')" align="center" width="120">
        <template slot-scope="scope">
      ...
      <!-- 经销商名称 -->
      <el-table-column :label="$t('table.subscribe.dname')" align="center" width="120">
        <template slot-scope="scope">
      ...
      <!-- 套餐名称 -->
      <el-table-column :label="$t('table.subscribe.pname')" align="center" width="150">
        <template slot-scope="scope">
      ...
      <!-- 详细地址 -->
      <el-table-column :label="$t('table.subscribe.address')" align="center" width="200">
        <template slot-scope="scope">
      ...
      <!-- 联系方式 -->
      <el-table-column :label="$t('table.subscribe.phone')" align="center" width="200">
        <template slot-scope="scope">
      ...
      <!-- 型号 -->
      <el-table-column :label="$t('table.subscribe.ename')" align="center" width="200">
        <template slot-scope="scope">
      ...
      <!-- 支付状态 -->
      <el-table-column :label="$t('table.subscribe.pay_type')" align="center" width="80">
        <template slot-scope="scope">
      ...
      <!-- 支付金额 -->
      <el-table-column :label="$t('table.subscribe.pay_money')" align="center" width="80">
        <template slot-scope="scope">
      ...
      <!-- 计费模式 -->
      <el-table-column :label="$t('table.subscribe.bill_id')" align="center" width="80">
        <template slot-scope="scope">
