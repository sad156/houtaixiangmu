<template>
  <div class="app-container">
    ...
    >
      ...
      <!-- 设备ID -->
      <el-table-column :label="$t('table.order.unitId')" align="center" width="120">
        <template slot-scope="scope">
      ...
      <!-- 客户姓名 -->
      <el-table-column :label="$t('table.order.userName')" align="center" width="120">
        <template slot-scope="scope">
      ...
      <!-- 支付来源 -->
      <el-table-column :label="$t('table.order.payType')" align="center" width="80">
        <template slot-scope="scope">
      ...
      <!-- 订单类型 -->
      <el-table-column :label="$t('table.order.orderType')" align="center" width="80">
        <template slot-scope="scope">
      ...
      <!-- 订单状态 -->
      <el-table-column :label="$t('table.order.isPay')" align="center" width="80">
        <template slot-scope="scope">
      ...
      <!-- 设备型号 -->
      <el-table-column :label="$t('table.order.equipmentName')" align="center" width="200">
        <template slot-scope="scope">
      ...
      <!-- 计费模式 -->
      <el-table-column :label="$t('table.order.bill')" align="center" width="200">
        <template slot-scope="scope">
      ...
      <!-- 时长 -->
      <el-table-column :label="$t('table.order.times')" align="center" width="100">
        <template slot-scope="scope">
      ...
      <!-- 详细地址 -->
      <el-table-column :label="$t('table.order.address')" align="center" width="400">
        <template slot-scope="scope">
      ...
      <!-- 级别 -->
      <el-table-column :label="$t('table.order.level')" align="center" width="80">
        <template slot-scope="scope">
      ...
      <!-- 联系方式 -->
      <el-table-column :label="$t('table.order.phone')" align="center" width="120">
        <template slot-scope="scope">
      ...
      <!-- 创建时间 -->
      <el-table-column :label="$t('table.order.createTime')" align="center" width="150">
        <template slot-scope="scope">
      ...
      <!-- 经销商ID -->
      <el-table-column :label="$t('table.order.dealerId')" align="center" width="200">
        <template slot-scope="scope">
      ...
      <!-- 经销商姓名 -->
      <el-table-column :label="$t('table.order.dealerName')" align="center" width="200">
        <template slot-scope="scope">
      ...
      <!-- 流量 -->
      <el-table-column :label="$t('table.order.flowmoney')" align="center" width="100">
        <template slot-scope="scope">
          <span>{{ scope.row.flowmoney }}</span>
        </template>
      </el-table-column>

      <!-- 订单编号 -->
      <el-table-column :label="$t('table.order.orderNumber')" align="center" width="200">
        <template slot-scope="scope">
      ...
      <!-- 流量套餐 -->
      <el-table-column :label="$t('table.order.packageFlow')" align="center" width="200">
        <template slot-scope="scope">
          <span>{{ scope.row.packageFlow }}</span>
        </template>
      </el-table-column>

      <!-- 套餐名称 -->
      <el-table-column :label="$t('table.order.packageName')" align="center" width="200">
        <template slot-scope="scope">
      ...
      <!-- 支付时间 -->
      <el-table-column :label="$t('table.order.payTime')" align="center" width="150">
        <template slot-scope="scope">
      ...
      <!-- 支付订单编号 -->
      <el-table-column :label="$t('table.order.payNumber')" align="center" width="200">
        <template slot-scope="scope">
